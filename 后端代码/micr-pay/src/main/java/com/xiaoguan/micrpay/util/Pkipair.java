package com.xiaoguan.micrpay.util;
...
//生成签名
    ...
    public boolean enCodeByCer( String val, String msg) {
        ...
        try {
            //快钱的公钥文件
            String file = Pkipair.class.getResource("99bill[1].cert.rsa.20140803.cer").toURI().getPath();//99bill[1].cert.rsa.20140803.cer             //  99bill.cert.rsa.20140803.cer
